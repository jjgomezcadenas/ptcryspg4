...
\caption{Dose (red) and total $\bplus$ activity (blue) for a \SI{100}{MeV} proton
pencil beam propagating in biological tissue, both in arbitrary units (each curve
normalised to its own peak). The dose rises slowly and then peaks sharply at the
Bragg peak, whereas the $\bplus$ activity is roughly flat along the track and falls
away just before it.}
\label{fig:source}
\end{figure}
