...
(\file{cylinder\_sobp\_1e7}: a brain-filled head cylinder) is worked through as a
...
\begin{figure}[t]
  ...
  standard \file{cylinder\_sobp\_1e7} case.}
  \label{fig:frame}
\end{figure}
...
\file{geometry} & string & phantom case: \file{cylinder} \textbar{} \file{uniform\_head} \textbar{} \file{mird\_head} \textbar{} \file{headep} \\
\file{phantom\_material} & string & single material, or \file{multi} (medium per-region in \file{phantom\_regions.csv}) \\
...
\section{Worked example: \file{cylinder\_sobp\_1e7}}
\label{sec:example}
