...
\item \textbf{Reconstruction is separate.} The simulation's output is the
coincidence list; any reconstructor reads it.
\end{itemize}
...
\textbf{analytic $\gamma$-transport Monte Carlo} (in Julia, the \texttt{PTCryspMC.jl}
