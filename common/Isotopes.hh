...
///
/// The proton run needs no half-lives -- Geant4's radioactive-decay process
/// handles the decay internally; what C++ needs is the mapping: residual
/// nucleus (Z, A) -> listed beta+ emitter? -> isotope_id. Half-lives and
/// endpoints live on the Python side (common/isotopes.py).
///
/// The authoritative contract is common/SCHEMA.md; this header and
/// common/isotopes.py both follow it.
